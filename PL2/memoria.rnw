...
\subsubsection{Definición del Conjunto de Datos}
...
\subsubsection{ Funciones Implementadas para el Cálculo Detallado}
...
\subsubsection{ Ejecución del Algoritmo Paso a Paso}
